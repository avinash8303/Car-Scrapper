    ...
    <>
      ...
      <main className="relative min-h-screen bg-[#F9FAFB] text-[#6B7280] overflow-x-hidden">
        ...
        <section className="relative w-full h-[70vh] md:h-[80vh] flex items-center justify-center text-center px-4 overflow-hidden">
          ...
          {/* Overlay */}
          <div className="absolute inset-0 bg-[#1A2E40]/70"></div>
        ...
        <section
          id="features"
          className="container mx-auto py-16 md:py-24 px-4 sm:px-6 text-center bg-[#E5E7EB] rounded-3xl shadow-2xl my-12 border border-[#4B5563]"
        >
          <h2 className="text-3xl lg:text-4xl font-extrabold mb-4 text-[#111827] drop-shadow-lg tracking-tight">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              ...
              >
                ...
                <h3 className="text-xl font-bold mb-2 text-[#111827] drop-shadow">
                  {feature.title}
                </h3>
        ...
        <section className="bg-[#F9FAFB] py-16 md:py-24 px-4 sm:px-6">
          <div className="container mx-auto text-center">
            <h2 className="text-3xl lg:text-4xl font-extrabold mb-12 text-[#111827] drop-shadow-lg tracking-tight">
